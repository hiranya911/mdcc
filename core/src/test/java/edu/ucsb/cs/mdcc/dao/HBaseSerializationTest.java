...
public class HBaseSerializationTest extends TestCase {
    ...
    public void testOptionCollectionSerialization1() throws Exception {
        List<Option> options = new ArrayList<Option>();
        Option o1 = new Option("foo", ByteBuffer.wrap("foo-value".getBytes()), 100, false);
        options.add(o1);
        ...
        assertEquals(new String(o1Copy.getValue().array()), "foo-value");
    ...
    public void testOptionCollectionSerialization2() throws Exception {
        List<Option> options = new ArrayList<Option>();
        Option o1 = new Option("foo", ByteBuffer.wrap("foo-value".getBytes()), 100, false);
        Option o2 = new Option("bar", ByteBuffer.wrap("bar-value".getBytes()), 200, false);
        options.add(o1);
        options.add(o2);
        ...
        assertEquals(new String(o2Copy.getValue().array()), "bar-value");
